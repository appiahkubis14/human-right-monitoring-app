!(function () {
  var t = sessionStorage.getItem("__UPLON_CONFIG__"),
  ...
  (this.html = document.getElementsByTagName("html")[0]),
    ...
    (config.layout.mode = e.getAttribute("data-layout-mode") || o.layout.mode),
    (config.topbar.color =
      e.getAttribute("data-topbar-color") || o.topbar.color),
    (config.sidenav.size =
      e.getAttribute("data-sidenav-size") || o.sidenav.size),
