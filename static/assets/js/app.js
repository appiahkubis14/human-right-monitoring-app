      ...
      $(".side-nav a").each(function () {
        ...
        this.href == t &&
          ...
          (t = $(this)
            ...
            .parent()
            .parent()
            .parent()).is("body") || t.addClass("active"));
      }),
      setTimeout(function () {
        var t,
          n,
          ...
          r,
          s,
          e = document.querySelector("li.active .active");
        function l() {
          (t = s += 20), (e = o), (a = r);
          var t,
            e,
        ...
        null != e &&
          ...
          t &&
            100 < e &&
            ((i = 600), (o = (n = t).scrollTop), (r = e - o), (s = 0), l()));
      }, 200));
  }
  initTopbarMenu() {
    $(".navbar-nav").length &&
    ...
    $('[data-plugin="custommodal"]').on("click", function (t) {
      t.preventDefault(),
        new Custombox.modal({
          ...
          overlay: { color: $(this).attr("data-overlayColor") },
        }).open();
    });
  }
  initCounterUp() {
    $(this).attr("data-delay") && $(this).attr("data-delay"),
      $(this).attr("data-time") && $(this).attr("data-time");
    $('[data-plugin="counterup"]').each(function (t, e) {
      $(this).counterUp({ delay: 100, time: 1200 });
    });
  }
  initPeityCharts() {
    $('[data-plugin="peity-pie"]').each(function (t, e) {
      var a = $(this).attr("data-colors")
      ...
      $(this).peity("pie", { fill: a, width: n, height: i });
    }),
      $('[data-plugin="peity-donut"]').each(function (t, e) {
        var a = $(this).attr("data-colors")
          ...
          n = $(this).attr("data-width") ? $(this).attr("data-width") : 20,
          i = $(this).attr("data-height") ? $(this).attr("data-height") : 20;
        $(this).peity("donut", { fill: a, width: n, height: i });
      }),
      ...
      $('[data-plugin="peity-bar"]').each(function (t, e) {
        var a = $(this).attr("data-colors")
          ...
          n = $(this).attr("data-width") ? $(this).attr("data-width") : 20,
          i = $(this).attr("data-height") ? $(this).attr("data-height") : 20;
        $(this).peity("bar", { fill: a, width: n, height: i });
      });
  }
  initKnob() {
...
class ThemeCustomizer {
  ...
  changeMenuColor(t) {
    (this.config.menu.color = t),
      this.html.setAttribute("data-menu-color", t),
      this.setSwitchFromConfig();
  }
  changeLeftbarSize(t, e = !0) {
    this.html.setAttribute("data-sidenav-size", t),
      e && ((this.config.sidenav.size = t), this.setSwitchFromConfig());
  }
  changeLayoutMode(t, e = !0) {
    this.html.setAttribute("data-layout-mode", t),
      e && ((this.config.layout.mode = t), this.setSwitchFromConfig());
  }
  changeLayoutColor(t) {
    (this.config.theme = t),
      this.html.setAttribute("data-bs-theme", t),
      this.setSwitchFromConfig();
  }
  changeTopbarColor(t) {
    (this.config.topbar.color = t),
      this.html.setAttribute("data-topbar-color", t),
      this.setSwitchFromConfig();
  }
  resetTheme() {
  ...
  initSwitchListener() {
        ...
        (t &&
          t.addEventListener("click", function () {
            ...
            "full" === e
              ...
              : "fullscreen" == t
              ? "fullscreen" === e
                ? a.changeLeftbarSize("fullscreen" == t ? "default" : t, !1)
                : a.changeLeftbarSize("fullscreen", !1)
              : "condensed" === e
              ? a.changeLeftbarSize("condensed" == t ? "default" : t, !1)
    ...
    t &&
      ...
      document.querySelectorAll(".button-sm-hover").forEach(function (t) {
        t.addEventListener("click", function () {
          var t = a.config.sidenav.size;
          "sm-hover-active" === a.html.getAttribute("data-sidenav-size", t)
  ...
  setSwitchFromConfig() {
    sessionStorage.setItem("__UPLON_CONFIG__", JSON.stringify(this.config)),
      document
    ...
    i &&
      ...
      (e = document.querySelector(
        "input[type=radio][name=data-layout-mode][value=" + i.layout.mode + "]"
      )),
      ...
      (n = document.querySelector(
        "input[type=radio][name=data-menu-color][value=" + i.menu.color + "]"
      )),
